...
--
-- Host: localhost
-- Generation Time: Jan 15, 2025 at 06:39 PM
...
--
-- Table structure for table `vendor_tradetracker_material_bannerimageitems`
--

CREATE TABLE `vendor_tradetracker_material_bannerimageitems` (
...
--
-- Indexes for table `vendor_tradetracker_material_bannerimageitems`
--
ALTER TABLE `vendor_tradetracker_material_bannerimageitems`
  ADD PRIMARY KEY (`id`),
  ...
  ADD KEY `materialOutputType` (`materialOutputType`);
...
--
-- AUTO_INCREMENT for table `vendor_tradetracker_material_bannerimageitems`
--
ALTER TABLE `vendor_tradetracker_material_bannerimageitems`
