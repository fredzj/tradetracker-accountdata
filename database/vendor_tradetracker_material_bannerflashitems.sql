...
--
-- Table structure for table `vendor_tradetracker_material_bannerflashitems`
--

CREATE TABLE `vendor_tradetracker_material_bannerflashitems` (
...
--
-- Indexes for table `vendor_tradetracker_material_bannerflashitems`
--
ALTER TABLE `vendor_tradetracker_material_bannerflashitems`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `vendor_tradetracker_material_bannerflashitems`
--
ALTER TABLE `vendor_tradetracker_material_bannerflashitems`
