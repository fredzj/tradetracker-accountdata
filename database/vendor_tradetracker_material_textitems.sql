...
--
-- Table structure for table `vendor_tradetracker_material_textitems`
--

CREATE TABLE `vendor_tradetracker_material_textitems` (
...
--
-- Indexes for table `vendor_tradetracker_material_textitems`
--
ALTER TABLE `vendor_tradetracker_material_textitems`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `vendor_tradetracker_material_textitems`
--
ALTER TABLE `vendor_tradetracker_material_textitems`
