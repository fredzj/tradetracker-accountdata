...
--
-- Table structure for table `vendor_tradetracker_material_incentiveofferitems`
--

CREATE TABLE `vendor_tradetracker_material_incentiveofferitems` (
...
--
-- Indexes for table `vendor_tradetracker_material_incentiveofferitems`
--
ALTER TABLE `vendor_tradetracker_material_incentiveofferitems`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `vendor_tradetracker_material_incentiveofferitems`
--
ALTER TABLE `vendor_tradetracker_material_incentiveofferitems`
