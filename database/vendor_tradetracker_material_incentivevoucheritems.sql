...
--
-- Table structure for table `vendor_tradetracker_material_incentivevoucheritems`
--

CREATE TABLE `vendor_tradetracker_material_incentivevoucheritems` (
...
--
-- Indexes for table `vendor_tradetracker_material_incentivevoucheritems`
--
ALTER TABLE `vendor_tradetracker_material_incentivevoucheritems`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `vendor_tradetracker_material_incentivevoucheritems`
--
ALTER TABLE `vendor_tradetracker_material_incentivevoucheritems`
